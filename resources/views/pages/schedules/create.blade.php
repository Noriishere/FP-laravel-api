            ...
            <form method="POST" action="{{ route('schedules.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="driver_id" id="driver_select"
                            ...
                            <div id="driverLoading" class="hidden absolute right-3 top-1/2 -translate-y-1/2">
                                <svg class="animate-spin w-4 h-4 text-primary" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <span
                                class="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-gray-400 pointer-events-none">Rp</span>
                            <input type="number" name="price" value="{{ old('price') }}" min="0" step="1000" placeholder="0"
