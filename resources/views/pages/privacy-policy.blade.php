...
<section class="relative overflow-hidden bg-dark py-28">
    ...
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute left-1/2 top-1/2 h-[700px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-3xl"></div>
    ...
    <div class="relative mx-auto max-w-5xl px-6 lg:px-12 text-center">
        ...
        <div class="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-bold uppercase tracking-widest text-white/70">
        ...
        <div class="mt-8 inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 text-sm text-white/50">
                    ...
                    <div class="mt-8 grid gap-4">
                        ...
                        @foreach($usages as $usage)
                            <div class="flex items-start gap-4 rounded-2xl border border-borderColor bg-bg px-5 py-4">
                                <div class="mt-1 flex h-6 w-6 items-center justify-center rounded-full bg-primary text-white">
