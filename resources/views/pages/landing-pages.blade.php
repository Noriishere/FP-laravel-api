...
@section('content')
    ...
    <section class="relative overflow-hidden px-6 py-6 lg:px-12">
        ...
        <div class="mx-auto grid min-h-[calc(100vh-70px)] max-w-7xl items-center gap-16 lg:grid-cols-2">
            ...
            <div>
                ...
                <div
                    class="mb-7 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-primary">
            ...
            <div class="relative flex items-center justify-center">
                ...
                <div
                    class="absolute -right-6 -top-6 h-28 w-28 bg-[radial-gradient(circle,#d0cbc2_1.5px,transparent_1.5px)] bg-[length:14px_14px] opacity-60">
                </div>

                <div
                    class="relative aspect-[4/3] w-full max-w-2xl overflow-hidden rounded-[28px] border border-borderColor bg-gradient-to-br from-[#f0ede8] to-[#e8e3dc] shadow-2xl">

                    <img src="#" alt="GASSIN Shuttle" class="h-full w-full object-cover hidden"
                ...
                <div
                    class="absolute bottom-5 left-5 flex items-center gap-3 rounded-2xl bg-white/90 px-5 py-4 shadow-xl backdrop-blur">
    ...
    <section id="fitur" class="border-t border-borderColor bg-white px-6 py-24 lg:px-12">
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="mt-16 grid gap-6 lg:grid-cols-3">
                ...
                <div
                    class="rounded-3xl border border-borderColor bg-bg p-9 transition hover:-translate-y-2 hover:border-primary/30 hover:shadow-2xl">
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="relative mt-20 grid gap-10 lg:grid-cols-3">
                ...
                <div class="text-center">
                    ...
                    <div
                        class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border-2 border-borderColor bg-white">
            ...
            <div>
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    ...
                    <a href="mailto:naltydev@gmail.com"
                        class="inline-flex items-center gap-3 rounded-2xl bg-dark px-7 py-4 text-sm font-bold text-white transition hover:-translate-y-1 hover:bg-black">
    ...
    <section id="download" class="relative overflow-hidden bg-dark px-6 py-28 text-center lg:px-12">
        ...
        <div
            class="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/20 blur-3xl">
        </div>
    ...
    <footer
        class="flex flex-col items-center justify-between gap-3 border-t border-borderColor bg-white px-6 py-8 text-center lg:flex-row lg:px-12">
