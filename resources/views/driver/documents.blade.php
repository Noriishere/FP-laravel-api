        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow p-6">
                ...
                <form action="{{ route('driver.documents.upload') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input type="file" name="file" class="w-full border rounded-xl px-4 py-3" required>
            ...
            <div class="bg-white rounded-2xl shadow p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    @if ($driver?->verification_status === 'approved') bg-green-100 text-green-700
        ...
        ">
                            ...
                            @if ($document->status === 'rejected' && $document->note)
                                <div class="mt-4 bg-red-50 border border-red-200 rounded-xl p-4">
                                    ...
                                    <h5 class="text-sm font-semibold text-red-700 mb-1">
                                        Alasan Penolakan
                                    </h5>
