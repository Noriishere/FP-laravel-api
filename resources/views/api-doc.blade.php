        ...
        window.onload = function () {
            const spec = {
                ...
                "paths": {
                    ...
                    "/bookings": {
                        "post": { "tags": ["Customer"], "summary": "Store Booking", "requestBody": { "required": true, "content": { "application/json": { "schema": { "type": "object", "properties": { "schedule_id": { "type": "integer" }, "pickup_stop_id": { "type": "integer" }, "dropoff_stop_id": { "type": "integer" }, "seat_ids": { "type": "array", "items": { "type": "integer" } } } } } }, "responses": { "200": { "description": "Success" } } } },
